...
public class CardTrick {
    ...
    private static void printInfo() {
        ...
        System.out.println("My name is Juan Jose Alvarez Gil but you can call me Juan");
        System.out.println();
        
        System.out.println("My career ambitions:");
        System.out.println(" I'm just finding out if it's my thing");
        System.out.println("to finish my career and give my best");
	System.out.println();	

        System.out.println("My hobbies:");
        System.out.println(" Play VideoGames");
        System.out.println(" Walk dogs");
        System.out.println(" Read Manga");
